 ...
 *
 * Given an input file with a sequence of virtual addresses, 
 * this program translates the virtual address by first extracting 
 * the page number and offset, second finding the frame number.
 * Then the program fetches the content of the simulated 
 * physical memeory.
 * 
 * Assumptions:
 *  - the page size is PAGE_SIZE (256) bytes
 *  - the max virtual address space is PAGE_TABLE_ENTRIES*PAGE_SIZE (64k) bytes
 *  - the physical address space is NUMBER_FRAMES*PAGE_SIZE (64k) bytes
 *
 * Usage:
 *	java VM <input file>
 */
